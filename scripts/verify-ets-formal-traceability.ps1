# scripts/apply-ets-reproducibility-matrix-sprint.ps1
# Purpose: Complete ETS sprint recommendation:
# Add ETS reproducibility matrix and harden reproducibility/verifier documentation.
...
Write-Utf8NoNewline -Path "docs/research/reproducibility-matrix.md" -Content $matrix

$appendix = @'
# Reproducibility Appendix

This appendix records how to reproduce ETS RC research artifacts from a clean checkout.

ETS is the **Evidence Transparency System**. Reproducibility means that a verifier can reproduce a verification decision or research artifact result from committed source, exported proof material, deterministic sample data, and documented commands. It does not prove real-world truth, legal sufficiency, election correctness, or completeness.

See [`reproducibility-matrix.md`](reproducibility-matrix.md) for the artifact-by-artifact matrix.
...
.\scripts\verify-ets-reproducibility-matrix.ps1
