...
_SOURCE_KEY_VERSION = "9f578feb997d49abb0a42b5e41651996"
...
def verify_offline(
    *,
    ...
    if not expected_source_key_id.rstrip("/").endswith("/" + _SOURCE_KEY_VERSION):
    ...
    if alternate_public_key_pem is not None:
        ...
        if verify_tree_head_signature(tree_head, alternate_der.hex()):
            raise OfflineVerificationError("Alternate public key unexpectedly verified source evidence")
    ...
    return {
        ...
        "source_key_version": _SOURCE_KEY_VERSION,
