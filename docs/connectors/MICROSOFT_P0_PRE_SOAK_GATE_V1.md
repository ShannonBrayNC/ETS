...
subscription. A protected retry may begin enabled only when the prior exact-source failure artifact
proves mutation and fail-closed restoration completed with the final state enabled. The gate still
