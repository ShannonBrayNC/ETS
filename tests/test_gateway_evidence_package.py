...
def _event(*, raw_source_payload_retained: bool = False) -> EvidenceEvent:
...
def _bundle(*, raw_source_payload_retained: bool = False) -> EvidenceProofBundle:
    log = InMemoryAppendOnlyLog()
    entry = log.append(_event(raw_source_payload_retained=raw_source_payload_retained))
