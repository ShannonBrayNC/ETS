...
from ets.qualification.physical_edge import EdgeCompactR0BenchManifest, load_manifest, readiness_issues
    ...
    *,
    ...
    for receipt in proofs:
        ...
        if key in proof_keys:
            issues.append(
                f"R0.9: duplicate proof receipt for {receipt.subject_kind.value}:{receipt.subject_id}"
            )
            continue
