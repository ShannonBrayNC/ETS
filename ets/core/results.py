...
class VerificationStatus(StrEnum):
    """Closed set of top-level verification outcomes."""
...
class VerificationReason(StrEnum):
    """Stable machine-readable reason codes for verification outcomes."""
...
class VerifiedComponent(StrEnum):
    """Protocol component evaluated by a verification operation."""
...
class VerificationResult:
    """Immutable, deterministic outcome returned for untrusted material."""
    ...
    @property
    def valid(self) -> bool:
        """Return whether this result represents successful verification."""
